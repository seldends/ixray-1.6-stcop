...
{
    float3 t_0 = saturate(s_base0.Sample(smp_rtlinear, I.Tex0)).xyz;
    float3 t_1 = saturate(s_base1.Sample(smp_rtlinear, I.Tex1)).xyz;
    ...
    image = (image * I.Color.xyz + c_brightness) * 2.0f;
